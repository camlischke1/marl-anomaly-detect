...
testX = np.load('fgsm_data_nav/fgsm_testX100.0.npy')
testY = np.load('fgsm_data_nav/fgsm_testY100.0.npy')
trueActions = np.load('fgsm_data_nav/fgsm_trueActions100.0.npy')
print(testX.shape)
print(testY.shape)
