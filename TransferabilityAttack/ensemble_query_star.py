...
#reading data
input = np.load("../Datasets/datasets_star_whiterandom/SC_random_time_0.5_test.npy", allow_pickle=True)
...
np.save('fgsm_data_star/query_starX.npy', testX)
...
np.save('fgsm_data_star/query_starY.npy', finalQueryY)
