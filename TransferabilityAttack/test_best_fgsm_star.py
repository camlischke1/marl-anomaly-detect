...
#reading data
input = np.load("../Datasets/datasets_star_blacktimed/BB_SC_strategic_1.npy", allow_pickle=True)
...
print(testX.shape)
print(testY.shape)
testX = attack(testX,testY,0.7)
print(testX.shape)
print(testY.shape)
print(np.unique(testY,return_counts=True))


binary_model = load_model('../BinaryNets/LSTMStarBlackTimed.keras')
